...
class EventCounter:
    ...
    def __init__(self, event_min, event_max, log, level_min=-1, level_max=-1, event_per_level=-1, event_per_level_in_file=-1):
        ...
        if level_min == -1 :
            level_min = 0
            level_max = 0
            event_per_level = self.event_max-self.event_min
            event_per_level_in_file = self.event_max-self.event_min
